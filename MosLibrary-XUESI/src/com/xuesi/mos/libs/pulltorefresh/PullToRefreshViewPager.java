...
public class PullToRefreshViewPager extends PullToRefreshBase<ViewPager> {
	...
	public PullToRefreshViewPager(Context context, Mode mode) {
		// TODO lzq add data:2015-11-18
		super(context, mode);
	}

	public PullToRefreshViewPager(Context context, Mode mode, AnimationStyle animStyle) {
		// TODO lzq add data:2015-11-18
