...
import com.xuesi.mos.libs.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.xuesi.mos.libs.pulltorefresh.internal.IndicatorLayout;
	...
	public final void setEmptyView(View newEmptyView) {
		...
		if (null == mEmptyView) {
			if (null != newEmptyView) {
				// New view needs to be clickable so that Android recognizes it
				// as a
