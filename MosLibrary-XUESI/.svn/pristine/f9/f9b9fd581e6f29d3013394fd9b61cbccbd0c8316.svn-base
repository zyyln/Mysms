...
class ItemCustomLayout extends FrameLayout {
	...
	public ItemCustomLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		addView(mBGImage, 0, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				ViewGroup.LayoutParams.MATCH_PARENT));
	}

	public void addCustomView(View customView) {
		addView(customView, 1, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
				ViewGroup.LayoutParams.MATCH_PARENT));
	}
