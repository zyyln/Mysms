...
public class BarCodeReader {
	...
	private static final int BCRDR_MSG_ALL_MSGS_KT45 = 0x3F03FF;
	private static final int BCRDR_MSG_ALL_MSGS_TT35 = 0x3F01FF;
	 ...
	 * {@link BarCodeReader.PreviewCallback#onVideoFrame(format, width, height, byte[], BarCodeReader)}
	 * will be called when preview data becomes available. The data passed will
	 * be in the format and resolution specified by ParamNum.IMG_FILE_FORMAT and
	 * ParamNum.IMG_VIDEOSUB.
	 */
	 ...
	 * if
	 * {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#isSmoothZoomSupported}
	 * returns true.
	 * 
	 * @param value
	 *            zoom value. The valid range is 0 to
	 *            {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#getMaxZoom}
	 *            .
	 ...
	 * {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#getFocusMode()}
	 ...
	 * {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#FLASH_MODE_OFF}
	...
	public interface PreviewCallback {
		 ...
		 *            with
		 *            {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#getPreviewFormat()}
		 *            . If
		 *            {@link com.motorolasolutions.adc.decoder.BarCodeReader.Parameters#setPreviewFormat(int)}
	...
	private class EventHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case BCRDR_MSG_DEC_COUNT:
				if (mDecodeCallback != null) {
					mDecodeCallback
							.onDecodeComplete(msg.arg1, DECODE_STATUS_MULTI_DEC_COUNT, (byte[]) msg.obj, mReader);
				}
				return;
